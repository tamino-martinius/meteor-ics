...
(function() {
  ...
  // Recurring-Property
  iCalendar.properties.Recurring = function(value) {
    iCalendar.properties.Base.call(this, 'RRULE', value);
  };

  iCalendar.properties.Recurring.prototype = Object.create(iCalendar.properties.Base.prototype);
  iCalendar.properties.Recurring.prototype.constructor = iCalendar.properties.Base;

  iCalendar.properties.Recurring.prototype.validateValue = function(value) {
    expectValueType(value, iCalendar.dataTypes.Text);
    return value;
  };
  ...
  // set Recurring
  iCalendar.EventBuilder.prototype.setRecurring = function(text) {
    this.event.addProperty(
      new iCalendar.properties.Recurring(
        new iCalendar.dataTypes.Text(text)
      )
    );
  };
